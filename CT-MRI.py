...
def main():
    try:
        ...
        for epoch in range(1, config['num_epochs'] + 1):
            ...
            if epoch % 50 == 0:
                torch.save(G_AB.state_dict(), os.path.join(config['save_dir'], f'G_AB_epoch_{epoch:04d}.pth'))
                torch.save(G_BA.state_dict(), os.path.join(config['save_dir'], f'G_BA_epoch_{epoch:04d}.pth'))
                torch.save(D_A.state_dict(), os.path.join(config['save_dir'], f'D_A_epoch_{epoch:04d}.pth'))
                torch.save(D_B.state_dict(), os.path.join(config['save_dir'], f'D_B_epoch_{epoch:04d}.pth'))
